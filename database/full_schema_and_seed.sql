...
BEGIN
    ...
    INSERT INTO products (name, description, category_id) VALUES ('Establecimiento Adicional (Planes Ilimitados)', 'Sucursal extra en planes Ilimitados', cat_mod_id) RETURNING id INTO prod_id;
