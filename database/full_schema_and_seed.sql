...
BEGIN
    ...
    INSERT INTO prices (product_id, channel_id, price, duration_label) VALUES 
    (prod_id, chan_azur_id, 25.00, '1 MES'), (prod_id, chan_local_id, 25.00, '1 MES'),
    (prod_id, chan_azur_id, 72.75, '3 MESES'), (prod_id, chan_local_id, 72.75, '3 MESES'),
    (prod_id, chan_azur_id, 141.00, '6 MESES'), (prod_id, chan_local_id, 141.00, '6 MESES'),
    (prod_id, chan_azur_id, 260.00, '12 MESES'), (prod_id, chan_local_id, 260.00, '12 MESES');
    ...
    INSERT INTO prices (product_id, channel_id, price, duration_label) VALUES 
    (prod_id, chan_azur_id, 421.20, '1 AÑO'), (prod_id, chan_local_id, 421.20, '1 AÑO');

    -- MICRO
    INSERT INTO products (name, description, category_id, features) VALUES 
    ('PLAN MICRO', 'Ideal para emprendedores', cat_plan_id, '{"Comprobantes año": "30", "Usuarios": 1, "Puntos de Emisión": 1, "Empresas": 1, "Establecimientos": 1, "Inventario": false, "Proformas": true, "Soporte Técnico": true, "Portal Clientes": true, "SMTP Propio": false, "Compras": false, "Retenciones": false, "Guías de Remisión": false, "Liquidación Compras": false, "Cuentas por Cobrar": false, "Cuentas por Pagar": false, "Notas de Débito": false, "Generación ATS": false, "Reportes": true, "API REST": false}') RETURNING id INTO prod_id;
    
    INSERT INTO prices (product_id, channel_id, price, duration_label) VALUES 
    (prod_id, chan_azur_id, 13.00, '1 AÑO'), (prod_id, chan_local_id, 13.00, '1 AÑO'),
    (prod_id, chan_azur_id, 24.70, '2 AÑOS'), (prod_id, chan_local_id, 24.70, '2 AÑOS'),
    (prod_id, chan_azur_id, 35.88, '3 AÑOS'), (prod_id, chan_local_id, 35.88, '3 AÑOS'),
    (prod_id, chan_azur_id, 46.80, '4 AÑOS'), (prod_id, chan_local_id, 46.80, '4 AÑOS'),
    (prod_id, chan_azur_id, 57.20, '5 AÑOS'), (prod_id, chan_local_id, 57.20, '5 AÑOS');
    ...
    (prod_id, chan_azur_id, 55.20, '3 AÑOS'), (prod_id, chan_local_id, 55.20, '3 AÑOS'),
    (prod_id, chan_azur_id, 72.00, '4 AÑOS'), (prod_id, chan_local_id, 72.00, '4 AÑOS'),
    (prod_id, chan_azur_id, 88.00, '5 AÑOS'), (prod_id, chan_local_id, 88.00, '5 AÑOS');
    ...
    (prod_id, chan_local_id, 82.80, '3 AÑOS'), (prod_id, chan_azur_id, 82.80, '3 AÑOS'),
    (prod_id, chan_local_id, 108.00, '4 AÑOS'), (prod_id, chan_azur_id, 108.00, '4 AÑOS'),
    (prod_id, chan_local_id, 132.00, '5 AÑOS'), (prod_id, chan_azur_id, 132.00, '5 AÑOS');

    -- ESPECIAL
    INSERT INTO products (name, description, category_id, features) VALUES 
    ('PLAN ESPECIAL', 'Funcionalidades completas', cat_plan_id, '{"Comprobantes año": "250", "Usuarios": 3, "Puntos de Emisión": 2, "Empresas": 1, "Establecimientos": 2, "Inventario": true, "Proformas": true, "Soporte Técnico": true, "Portal Clientes": true, "SMTP Propio": true, "Compras": true, "Retenciones": true, "Guías de Remisión": true, "Liquidación Compras": true, "Cuentas por Cobrar": true, "Cuentas por Pagar": false, "Notas de Débito": true, "Generación ATS": false, "Reportes": true, "API REST": true}') RETURNING id INTO prod_id;
    
    INSERT INTO prices (product_id, channel_id, price, duration_label) VALUES 
    (prod_id, chan_azur_id, 40.00, '1 AÑO'), (prod_id, chan_local_id, 40.00, '1 AÑO'),
    (prod_id, chan_azur_id, 76.00, '2 AÑOS'), (prod_id, chan_local_id, 76.00, '2 AÑOS'),
    (prod_id, chan_azur_id, 110.40, '3 AÑOS'), (prod_id, chan_local_id, 110.40, '3 AÑOS'),
    (prod_id, chan_azur_id, 144.00, '4 AÑOS'), (prod_id, chan_local_id, 144.00, '4 AÑOS'),
    (prod_id, chan_azur_id, 176.00, '5 AÑOS'), (prod_id, chan_local_id, 176.00, '5 AÑOS');
    ...
    (prod_id, chan_azur_id, 95.00, '2 AÑOS'), (prod_id, chan_local_id, 95.00, '2 AÑOS'),
    (prod_id, chan_azur_id, 138.00, '3 AÑOS'), (prod_id, chan_local_id, 138.00, '3 AÑOS'),
    (prod_id, chan_azur_id, 180.00, '4 AÑOS'), (prod_id, chan_local_id, 180.00, '4 AÑOS'),
    (prod_id, chan_azur_id, 220.00, '5 AÑOS'), (prod_id, chan_local_id, 220.00, '5 AÑOS');
    ...
    (prod_id, chan_azur_id, 133.00, '2 AÑOS'), (prod_id, chan_local_id, 133.00, '2 AÑOS'),
    (prod_id, chan_azur_id, 193.20, '3 AÑOS'), (prod_id, chan_local_id, 193.20, '3 AÑOS'),
    (prod_id, chan_azur_id, 252.00, '4 AÑOS'), (prod_id, chan_local_id, 252.00, '4 AÑOS'),
    (prod_id, chan_azur_id, 308.00, '5 AÑOS'), (prod_id, chan_local_id, 308.00, '5 AÑOS');
    ...
    (prod_id, chan_azur_id, 190.00, '2 AÑOS'), (prod_id, chan_local_id, 190.00, '2 AÑOS'),
    (prod_id, chan_azur_id, 276.00, '3 AÑOS'), (prod_id, chan_local_id, 276.00, '3 AÑOS'),
    (prod_id, chan_azur_id, 360.00, '4 AÑOS'), (prod_id, chan_local_id, 360.00, '4 AÑOS'),
    (prod_id, chan_azur_id, 440.00, '5 AÑOS'), (prod_id, chan_local_id, 440.00, '5 AÑOS');
    ...
    (prod_id, chan_azur_id, 331.20, '3 AÑOS'), (prod_id, chan_local_id, 331.20, '3 AÑOS'),
    (prod_id, chan_azur_id, 432.00, '4 AÑOS'), (prod_id, chan_local_id, 432.00, '4 AÑOS'),
    (prod_id, chan_azur_id, 528.00, '5 AÑOS'), (prod_id, chan_local_id, 528.00, '5 AÑOS');

    -- ILIMITADO
    INSERT INTO products (name, description, category_id, features) VALUES 
    ('PLAN ILIMITADO', 'Sin límites', cat_plan_id, '{"Comprobantes año": "Ilimitado", "Usuarios": 5, "Puntos de Emisión": 10, "Empresas": 1, "Establecimientos": 3, "Inventario": true, "Proformas": true, "Soporte Técnico": true, "Portal Clientes": true, "SMTP Propio": true, "Compras": true, "Retenciones": true, "Guías de Remisión": true, "Liquidación Compras": true, "Cuentas por Cobrar": true, "Cuentas por Pagar": true, "Notas de Débito": true, "Generación ATS": true, "Reportes": true, "API REST": true}') RETURNING id INTO prod_id;
    
    INSERT INTO prices (product_id, channel_id, price, duration_label) VALUES 
    (prod_id, chan_azur_id, 150.00, '1 AÑO'), (prod_id, chan_local_id, 150.00, '1 AÑO'),
    (prod_id, chan_azur_id, 285.00, '2 AÑOS'), (prod_id, chan_local_id, 285.00, '2 AÑOS'),
    (prod_id, chan_azur_id, 414.00, '3 AÑOS'), (prod_id, chan_local_id, 414.00, '3 AÑOS'),
    (prod_id, chan_azur_id, 540.00, '4 AÑOS'), (prod_id, chan_local_id, 540.00, '4 AÑOS'),
    (prod_id, chan_azur_id, 660.00, '5 AÑOS'), (prod_id, chan_local_id, 660.00, '5 AÑOS');
    ...
    (prod_id, chan_azur_id, 552.00, '3 AÑOS'), (prod_id, chan_local_id, 552.00, '3 AÑOS'),
    (prod_id, chan_azur_id, 720.00, '4 AÑOS'), (prod_id, chan_local_id, 720.00, '4 AÑOS'),
    (prod_id, chan_azur_id, 880.00, '5 AÑOS'), (prod_id, chan_local_id, 880.00, '5 AÑOS');
    ...
    (prod_id, chan_azur_id, 690.00, '3 AÑOS'), (prod_id, chan_local_id, 690.00, '3 AÑOS'),
    (prod_id, chan_azur_id, 900.00, '4 AÑOS'), (prod_id, chan_local_id, 900.00, '4 AÑOS'),
    (prod_id, chan_azur_id, 1100.00, '5 AÑOS'), (prod_id, chan_local_id, 1100.00, '5 AÑOS');
    ...
    (prod_id, chan_azur_id, '7 DÍAS', 8.00, 8.00),
    (prod_id, chan_azur_id, '30 DÍAS', 10.69, 10.69),
    (prod_id, chan_azur_id, '1 AÑO', 19.13, 17.22),
    (prod_id, chan_azur_id, '2 AÑOS', 29.13, 26.22),
    (prod_id, chan_azur_id, '3 AÑOS', 39.57, 35.61),
    (prod_id, chan_azur_id, '4 AÑOS', 50.00, 45.00),
    (prod_id, chan_azur_id, '5 AÑOS', 60.00, 54.00);
    -- LOCAL
    INSERT INTO prices (product_id, channel_id, duration_label, price, renewal_price) VALUES
    ...
    (prod_id, chan_local_id, '3 AÑOS', 37.00, 35.15),
    (prod_id, chan_local_id, '4 AÑOS', 46.00, 43.70),
    (prod_id, chan_local_id, '5 AÑOS', 54.00, 51.30);
    ...
    (prod_id, chan_azur_id, '3 AÑOS', 41.74, 37.57),
    (prod_id, chan_azur_id, '4 AÑOS', 52.17, 46.95),
    (prod_id, chan_azur_id, '5 AÑOS', 61.74, 55.57);
    -- LOCAL
    INSERT INTO prices (product_id, channel_id, duration_label, price, renewal_price) VALUES
    (prod_id, chan_local_id, '1 AÑO', 18.00, 17.10),
    (prod_id, chan_local_id, '2 AÑOS', 28.00, 26.60),
    ...
    -- AZUR / WEB
    INSERT INTO prices (product_id, channel_id, duration_label, price, renewal_price) VALUES
    (prod_id, chan_azur_id, '1 AÑO', 37.00, 31.45),
    (prod_id, chan_azur_id, '2 AÑOS', 45.00, 38.25),
    (prod_id, chan_azur_id, '3 AÑOS', 58.00, 49.30),
    (prod_id, chan_azur_id, '4 AÑOS', 71.00, 60.35),
    (prod_id, chan_azur_id, '5 AÑOS', 81.00, 68.85);
    ...
    INSERT INTO products (name, description, category_id) VALUES ('Usuario Adicional (Micro a Especial II)', 'Acceso para un usuario extra (Planes Micro a Especial II)', cat_mod_id) RETURNING id INTO prod_id;
    ...
    INSERT INTO products (name, description, category_id) VALUES ('Usuario Adicional (Planes Ilimitados)', 'Acceso para un usuario extra en planes Ilimitados', cat_mod_id) RETURNING id INTO prod_id;
    ...
    INSERT INTO prices (product_id, channel_id, price, duration_label) VALUES (prod_id, chan_azur_id, 20.00, '1 MES'), (prod_id, chan_azur_id, 240.00, '1 AÑO'), (prod_id, chan_local_id, 20.00, '1 MES'), (prod_id, chan_local_id, 240.00, '1 AÑO');
    ...
    INSERT INTO products (name, description, category_id) VALUES ('Establecimiento Adicional', 'Sucursal extra (Planes Estándar)', cat_mod_id) RETURNING id INTO prod_id;
    ...
    INSERT INTO prices (product_id, channel_id, price, duration_label) VALUES (prod_id, chan_azur_id, 15.00, 'PAGO ÚNICO'), (prod_id, chan_local_id, 15.00, 'PAGO ÚNICO');
    ...
    INSERT INTO prices (product_id, channel_id, price, duration_label) VALUES (prod_id, chan_azur_id, 25.00, 'PAGO ÚNICO'), (prod_id, chan_local_id, 25.00, 'PAGO ÚNICO');
    ...
    INSERT INTO prices (product_id, channel_id, price, duration_label) VALUES (prod_id, chan_azur_id, 10.00, 'PAGO ÚNICO'), (prod_id, chan_local_id, 10.00, 'PAGO ÚNICO');
    ...
    INSERT INTO prices (product_id, channel_id, price, duration_label) VALUES (prod_id, chan_azur_id, 30.00, 'PAGO ÚNICO'), (prod_id, chan_local_id, 30.00, 'PAGO ÚNICO');
    ...
    INSERT INTO prices (product_id, channel_id, price, duration_label) VALUES (prod_id, chan_azur_id, 20.00, 'PAGO ÚNICO'), (prod_id, chan_local_id, 20.00, 'PAGO ÚNICO');
    ...
    INSERT INTO prices (product_id, channel_id, price, duration_label) VALUES (prod_id, chan_azur_id, 100.00, '1 AÑO'), (prod_id, chan_local_id, 100.00, '1 AÑO');
